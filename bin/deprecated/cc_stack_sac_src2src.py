...
def main(   fnm_wildcard, tmark, t1, t2, delta, pre_detrend=True, pre_taper_ratio= 0.005, pre_filter= None,
            ...
            dist_range = (0.0, 180.0), dist_step= 1.0, min_ev_per_rcv=1, dbaz_range= None, gcd_rcv_range= None, gc_center_rect= None, stack_method='linear',
...
def ccstack(spec_mat, stack_count, evlo_lst, evla_lst, stack_mat, dist_step, index_range, dist_start=0.0, stack_method='linear'):
    """
    """
    count = 0
    i1, i2 = index_range
...
def ccstack_selection_ev(spec_mat, stack_count, evlo_lst, evla_lst, baz_lst, stack_mat,
                        ...
                        center_clo1, center_clo2, center_cla1, center_cla2,
                        dist_step, index_range, dist_start=0.0, stack_method='linear'):
    """
    """
...
Args:
    ...
    [--stack_method] : can be 'linear' or 'PWS'
...
E.g.,
    %s -I "in*/*.sac" -T -5/10800/32400 -D 0.1 -O cc --out_format hdf5,sac
        ...
        --w_temporal 128.0/0.02/0.06667 --w_spec 0.02
        --stack_dist 0/180/1  --stack_method PWS
        --min_ev_per_rcv 100
    ...
    options, remainder = getopt.getopt(sys.argv[1:], 'I:T:D:O:',
                            ['pre_detrend', 'pre_taper=', 'pre_filter=',
                             'w_temporal=', 'w_spec=',
                             'stack_dist=', 'min_ev_per_rcv=', 'dbaz=', 'gcd_rcv=', 'gc_center_rect=', 'stack_method=',
    ...
    main(fnm_wildcard, tmark, t1, t2, delta, pre_detrend, pre_taper_ratio, pre_filter,
            ...
            dist_range, dist_step, min_ev_per_rcv, dbaz_range, gcd_rcv_range, gc_center_rect, stack_method,
